...
func TestCanParseUrlFromContainerBase(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			proxiedUrl:  "/v1/api/execute/57d4b724/getUser",
		...
		},
		{
			...
			baseUrl:     "http://localhost:8000",
			proxiedUrl:  "/v1/api/execute/57d4b724/getUser?query=param",
		...
		},
		{
			...
			baseUrl:     "http://localhost:8000",
			proxiedUrl:  "/v1/api/execute/57d4b724/getUser?query=param&param2=param2",
		...
		},
		{
			...
			baseUrl:     "http://localhost:8000",
			proxiedUrl:  "/v1/api/execute/57d4b724",
		...
		},
		{
			...
			baseUrl:     "http://localhost:8000",
			proxiedUrl:  "/v1/api/execute/57d4b724?id=1",
